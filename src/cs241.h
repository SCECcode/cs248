...
/* config string */
#define CS241_CONFIG_MAX 1000

// Structures
/** Defines a point (latitude, longitude, and depth) in WGS84 format */
typedef struct cs241_point_t {
...
typedef struct cs241_properties_t {
...
typedef struct cs241_configuration_t {
...
/** Queries the model */
int cs241_query(cs241_point_t *points, cs241_properties_t *data, int numpts);
...
void cs241_trilinear_interpolation(double x_percent, double y_percent, double z_percent, cs241_properties_t *eight_points,
							 cs241_properties_t *ret_properties);
